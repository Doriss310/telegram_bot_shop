EN = {
    ...
    "select_product": "👉 SELECT PRODUCT BELOW:",
    ...
    # Deposit
    "deposit_title": "💰 DEPOSIT FUNDS\n\nSelect amount or enter custom (VND):\n\n⚠️ Minimum: 5,000đ",
    "deposit_info": "💳 TRANSFER INFORMATION\n\n🏦 Bank: {bank}\n🔢 Account: {account}\n👤 Name: {name}\n💰 Amount: {amount}đ\n📝 Content: {code}\n\n⚠️ Scan QR or transfer manually\n✅ Funds will be added AUTOMATICALLY in 1-2 minutes",
